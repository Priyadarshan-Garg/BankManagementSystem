...
//        User user =  new User("Raghavan","Fuddi","Delhi");

        User user = new User();
        user.setUserName("Raghavan"); // userName set karein
        user.setAddress("Delhi");
        user.setPassword("Fuddi");


        BankService bankService = new BankService(user);
        bankService.createNewAcc(1729832, Account.accountType.Savings,user);
